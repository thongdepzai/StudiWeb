                ...
                <div className="banner__wrapper">
                    <div className="banner__content">
                        <div className="banner__content--title">
                            <h2>Luyện thi IELTS online: listening, speaking, reading, writing</h2>
                        </div>
                        <div className="banner__content--decription">
                            <p>Rèn luyện 4 kĩ năng, kèm theo giảng giải chi tiết về cấu trúc đề thi, nhưng lưu ý khi làm bài sẽ giúp bạn tự tin đạt 5 - 5,5 điểm IELTS.</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="dc-container">
                <div className="dc-content">
                    <div className="dc-content__img">
                        <img src="https://media.istockphoto.com/photos/do-you-speak-english-written-on-board-international-flag-in-box-picture-id1169984622" alt="abc" />
                    </div>
